 ...
 */
class getEditorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EditorRepository' shared autowired service.
     *
     * @return \App\Repository\EditorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EditorRepository.php';

        return $container->privates['App\\Repository\\EditorRepository'] = new \App\Repository\EditorRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
